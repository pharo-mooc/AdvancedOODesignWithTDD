...
The objective of these exercises is to get acquainted with the Pharo programming language.
...
Or the powerful version with eXtreme TDD (Test driven development):
